import { ABOUT_NEWS_ROUTE, ABOUT_REVIEWS_ROUTE, ABOUT_ROUTE, BASKET_OFFER_ROUTE, BASKET_ROUTE, CATALOG_SLUG_ROUTE, CATALOG_ROUTE, CONTACTS_ROUTE } from "@/utils/consts";
